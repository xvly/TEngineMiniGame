...
public class GameModule
{
    ...
    /// 获取UI模块。
    /// </summary>
    public static EntityModule Entity => _entity ??= new EntityModule();

    private static EntityModule _entity;
    
    public static ControllerModule Controller => _controller ??= new ControllerModule();

    private static ControllerModule _controller;

    public static CodeTypeModule CodeType => _codeType ??= new CodeTypeModule();
    private static CodeTypeModule _codeType;
